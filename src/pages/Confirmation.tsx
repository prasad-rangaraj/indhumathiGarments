      ...
      <div className="py-6 sm:py-8 px-4">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="card-elegant p-6 text-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-sm text-muted-foreground">
              Need help? Call us at +91 98765 43210 or email support@indhumathi.com
            </p>
          </div>
        </div>

        {/* Return & Exchange Policy */}
        <div className="card-elegant p-6 sm:p-7 mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-bold text-foreground mb-3">Return & Exchange Policy</h2>
          ...
          <p className="text-xs text-muted-foreground mt-3">
            ...
            call <span className="font-medium text-foreground">+91 98765 43210</span>.
          </p>
        </div>
