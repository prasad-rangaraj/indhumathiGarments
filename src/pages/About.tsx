...
const About = () => {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[calc(100vh-4rem)] flex items-center px-4 py-10 sm:py-12 md:py-16 overflow-hidden">
          ...
          <div className="text-animate">
            <div className="flex justify-center mb-4 sm:mb-6">
              <img 
                src={indhumathiLogo} 
                alt="Indhumathi" 
                className="h-20 sm:h-36 md:h-36 lg:h-52 w-auto object-contain animate-fade-in"
              />
            </div>
          ...
          <div className=" px-4 sm:px-6 py-6 sm:py-8 ">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-foreground">Skin Safe</h3>
                <p className="text-xs sm:text-sm text-muted-foreground">Hypoallergenic</p>
              </div>
              <div className="text-center">
                <div className="h-10 w-10 sm:h-12 sm:w-12 bg-gradient-to-r from-primary to-secondary rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
